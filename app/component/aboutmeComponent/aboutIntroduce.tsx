...
const AboutIntroduce = () => {
  const titleIntroduceRef = useRef<HTMLInputElement | null>(null)
  const contentIntroduce1Ref = useRef<HTMLInputElement | null>(null)
  const contentIntroduce2Ref = useRef<HTMLInputElement | null>(null)
  const imgIntroduce1Ref = useRef<HTMLInputElement | null>(null)
  const imgIntroduce2Ref = useRef<HTMLInputElement | null>(null)

  useEffect(() => {
    const onScroll: EventListener = () => {
      scrollEffect(titleIntroduceRef, "title-active")
      scrollEffect(contentIntroduce1Ref, "content-active")
      scrollEffect(contentIntroduce2Ref, "content-active")
      scrollEffect(imgIntroduce1Ref, "img-active")
      scrollEffect(imgIntroduce2Ref, "img-active")
    }
