...
const AboutTeam = () => {
  ...
  return (
    <div className="w-full h-[70vh] relative py-[40px] md:py-[60px] xl:py-[80px] bg-white">
      <div className="w-[95%] 2xl:w-[85%] mx-auto h-full flex flex-col md:flex-row gap-[30px] md:gap-0 items-center justify-center">
        <div ref={titleServiceRef} className="text-left md:w-1/2 mt-[30] mr-[50px] flex flex-col gap-[15px] opacity-0 translate-x-[-160px] transition-all duration-1000">
          <p className=" text-[#252525] text-[35px] md:text-[40px] xl:text-[45px] font-semibold tracking-[2px]">Team của
            chúng tôi</p>
        ...
        <div ref={mainServiceRef} className="w-full md:w-1/2 h-full overflow-hidden opacity-0 translate-x-[160px] transition-all duration-1000">
          <Image src={"/aboutme/team.png"} alt={""} width={0} height={0} sizes="100vh" className="w-full h-full object-cover object-center rounded-xl"/>
        </div>
      </div>
    </div>
  );
